...
$templateCache.put("views/landing-influencer.html", "<md-progress-linear ng-if=loadingTop class=md-warn md-mode=indeterminate style=\"position:absolute; top:-30px; width:100%; left:0\"></md-progress-linear><div class=container><div class=\"alert alert-warning\" role=alert>After Milestone 1, we will move from Window 95 to Material Design.</div><div class=jumbotron><h2>ReachRabbit Influencer</h2><p class=lead>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet. <a href=/#/brand>I\'m Brand.</a></p><social-linker on-already-logged-in=onAlreadyLoggedIn on-success=socialSelectionDone ng-model=socialAcc></social-linker></div></div>");
$templateCache.put("views/landing-brand.html", "<div class=container><div class=\"alert alert-warning\" role=alert>After Milestone 1, we will move from Window 95 to Material Design.</div><div class=jumbotron><h2>For Brands</h2><p class=lead>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet. <a href=/#/influencer>I\'m an influencer.</a></p><p><a class=\"btn btn-lg btn-default\" role=button ng-click=signup()>Sign Up Today</a> or <a class=signin href=/brand#/signin>Sign-in</a></p></div></div>");
$templateCache.put("partials/fb.pages.dialog1.tmpl.html", "<md-toolbar class=md-primary><div class=md-toolbar-tools><h3>Choose Facebook Page you want to associate</h3></div></md-toolbar><md-list><md-list-item class=md-2-line ng-if=\"pages.length == 0\"><div class=md-list-item-text><h3>You have no page.</h3><p>To sign up with facebook you need to have atleast one facebook page.</p></div></md-list-item><md-list-item class=md-2-line ng-repeat=\"item in pages\" ng-click=choose(item)><img ng-src={{item.picture.url}} class=md-avatar><div class=md-list-item-text><h3>{{item.name}} ({{item.id}})</h3><p>{{item.fan_count}} person liked this page.</p></div></md-list-item></md-list>");
