...
},{"./modules/landing":20}],18:[function(require,module,exports){
/**
...
},{"./socialProfile":22}],19:[function(require,module,exports){
/**
 ...
 */
 var loadSocialProfile = require('./socialProfile');
angular.module('app.landing')
.controller('brandAccountSigninController', ["$scope", "NcAlert", "$state", "$storage", "$api", function ($scope, NcAlert, $state, $storage, $api) {
    // on form submit
...
},{"./socialProfile":22}],20:[function(require,module,exports){
/**
 * Landing Module
 *
 * @author     Poon Wu <poon.wuthi@gmail.com
      ...
      .state('brand-signin', {
        ...
        views: {
          '': {
            ...
            templateUrl: 'views/signin-brand.html'
          }
        }
      });
	}]);
...
},{"../../components/common":16,"./adminLandingController.js":18,"./brandLandingController.js":19,"./index.js":20,"./influencerLandingController.js":21,"./socialProfile.js":22}],21:[function(require,module,exports){
/**
...
},{"./socialProfile":22}],22:[function(require,module,exports){
/**
 * helper -
...
$templateCache.put("views/signin-brand.html", "<h1><i class=\"fa fa-pied-piper\"></i></h1><h2>ReachRabbit <small>Brands Login</small></h2><form name=form class=form-horizontal ng-submit=submit(form) novalidate><div class=row><div class=col-md-6><div class=\"panel panel-default\"><div class=panel-body><nc-alert nc-model=alert></nc-alert><fieldset><div class=control-group><div class=controls><input required placeholder=Email name=email class=form-control ng-model=formData.email></div></div><br><div class=control-group><div class=controls><input type=password class=form-control required placeholder=Password name=password ng-model=formData.password></div></div></fieldset></div></div></div></div><div class=row><div class=col-md-6><button class=\"btn btn-primary\" type=submit>Sign-in</button></div></div></form>");
