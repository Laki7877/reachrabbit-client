...
angular.module('reachRabbitApp.common.service', ['satellizer'])
    ...
    .factory('customInjector', function (Config, $window, $q, $rootScope, $location, UserProfile) {
        var inj = {
            request: function (cc) {
                if (cc.url[0] === "/") {
    ...
    .config(function ($authProvider, Config, $httpProvider) {
            ...
            getAllInfluencer: function(params) {
                return $q(function (resolve, reject) {
                    $http({
                        ...
                        .then(function (influencerResponse) {
                            resolve(influencerResponse);
                        })
                        .catch(function (err) {
                            reject(err);
                        });
    ...
    .factory('InfluencerAccountService', function ($http) {
        return {
            /*
    ...
    .factory('BrandAccountService', function ($http) {
        return {
            /*
    ...
    .factory('CampaignService', function ($http, $q) {
    ...
    .factory('TransactionService', function ($http, $q) {
    ...
    .factory('$uploader', function (Upload, UploadValidate, $q, Config, $window, $timeout) {
        var service = {};
    ...
    .factory('CtrlHelper', function ($location, $anchorScroll, $rootScope) {
        return {
    ...
    .factory('UserProfile', function ($rootScope, $window) {
        return {
            get: function () {
    ...
    .factory('PublicService', function($http){
        return {
    ...
    .factory('LongPollingService', function ($http, $q, BusinessConfig, $location) {
        return {
