var brandCampaignDraft = function () {
    'use strict';
    ...
    this.doneCropBtn = element(by.css('.done-crop-btn'));
    this.nextMonthBtn = element(by.css('.uib-right'));
    this.dateCalendar = element.all(by.css(".uib-daypicker button"));
    this.alert = $('.alert.alert-success');
    //******************** functions *******************//
};
module.exports = new brandCampaignDraft();